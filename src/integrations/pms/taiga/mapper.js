...
/*export function mapTaigaUserStory(userStory) {
  if (!userStory) {
    throw new Error(
      "Cannot map an empty Taiga User Story."
    );
...
/*export function mapTaigaUserStory(userStory) {
  ...
  return {
    ...
    status: {
      ...
      name: userStory.status_extra_info?.name || "",
    },

    project: {
      id: userStory.project,

      name: userStory.project_extra_info?.name || "",
    },
